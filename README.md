...
UIは [TwitchTheater](https://twitchtheater.tv/) を参考に、左サイドバーから操作するシンプルな構成です。時刻ベースの同期機能と補正調整を備え、プレイヤーは公式のTwitch Embed を利用しています。
...
- **サイドバー**: 左上のボタンで開閉します。追加フォーム、同期用シークバー、API設定をまとめています。
